...
<footer id="colophon" class="site-footer border-top">
    <div class="container">
	        ...
	        <div class="site-info col-lg-7 col-md-7 col-12">
	            <div class="footer-menu-left">
					<?php if(! get_theme_mod('restaurant_zone_footer_text_setting') != ''){ ?>
					    <a href="<?php echo esc_url( __( 'https://wordpress.org/', 'digi-restaurant' ) ); ?>">
							<?php
							/* translators: %s: CMS name, i.e. WordPress. */
							printf( esc_html__( 'Proudly powered by %s', 'digi-restaurant' ), 'WordPress' );
							?>
					    </a>
					    <span class="sep mr-1"> | </span>
					    <span>
					    	<a target="_blank" href="<?php echo esc_url( __( 'https://www.themagnifico.net/themes/free-digi-restaurant-wordpress-theme/', 'digi-restaurant' ) ); ?>"> 
					           	<?php
					            	/* translators: %1$s: Digi Restaurant WordPress Theme,  */
					            	printf( esc_html__( ' %1$s ', 'digi-restaurant' ),'Digi Restaurant WordPress Theme' );
					            ?>
					        </a>
					        <?php
					        	/* translators: %1$s: TheMagnifico. */
					        	printf( esc_html__( 'by %1$s.', 'digi-restaurant' ),'TheMagnifico'  );
					        ?>
					    </span>
					<?php }?>
	    ...
	    <a id="button"><?php esc_html_e('TOP','digi-restaurant'); ?></a>
    </div>
</footer>
</div>
