...
function restaurant_zone_theme_color() {
    ...
    $restaurant_zone_preloader_dot_2_color = get_theme_mod('restaurant_zone_preloader_dot_2_color');
		...
		if(get_theme_mod('restaurant_zone_preloader_dot_2_color') == '') {
			$restaurant_zone_preloader_dot_2_color = '#ef2923';
		}
...
add_action('after_switch_theme', 'restaurant_zone_setup_options');

function restaurant_zone_setup_options () {
	wp_redirect( admin_url() . 'themes.php?page=restaurant-zone-info.php' );
}
...
function restaurant_zone_themepage(){
	$theme_info = add_theme_page( __('Theme Options','restaurant-zone'), __('Theme Options','restaurant-zone'), 'manage_options', 'restaurant-zone-info.php', 'restaurant_zone_info_page' );
}
...
function restaurant_zone_info_page() {
	...
	<div class="wrap about-wrap restaurant-zone-add-css">
		<div>
			<h1>
				<?php esc_html_e('Welcome To ','restaurant-zone'); ?><?php echo esc_html( $theme ); ?>
			</h1>
 ...
 */
add_filter('loop_shop_columns', 'restaurant_zone_loop_columns', 999);
